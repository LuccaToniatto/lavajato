...
<html lang="pt-br">
    ...
    <body>
        ...
        <header>
            <img src="imagens/logo.png" width="20%" height="20%"/>
                    ...
                    <div class="col">
                        <div class="card mb-2 rounded-2 shadow-sm">
                            <div class="card-hearder py-2 text-center">
                                ...
                                <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/></svg>&nbsp;<b>Editar usuario</b></h4>
                            </div>
                            ...
                            <form action="editarusuario.php?id=<?php echo $id; ?>" method="POST">
                                <div class="form-group col-7">
                                    ...
                                    <br/>
                                    <button type="submit" class="btn btn-outline-success">Atualizar Usuário</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-outline-primary" href="index.php" role="button">Voltar</a>
                                </form>
                                </div>
                            </div>
                        </div>
