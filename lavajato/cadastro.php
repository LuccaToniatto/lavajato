    ...
    <body>
        <form action="cad.php" method="POST">
            <div class="form-group">
                ...
                <br/>
                <label>Celular</label>
                <input type="number" class="form-control" name="celular" placeholder="Insira o numero de celular" required/>
                <br/>
                <label>Placa do Carro</label>
                <input type="text" class="form-control" name="placa" placeholder="Insira a placa do carro" required/>
                <br/>
                <label>Cidade</label>
